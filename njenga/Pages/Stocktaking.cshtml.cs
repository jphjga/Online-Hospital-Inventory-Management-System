...
public class StocktakingModel : PageModel
{
    private readonly DatabaseContext _context;

    // For the right column: existing stock-taking records
    public List<StockTaking> StockTakings { get; set; } = new List<StockTaking>();

    // For the left column: products for the stock-taking exercise
    public List<ProductStockViewModel> Products { get; set; } = new List<ProductStockViewModel>();

    public StocktakingModel(DatabaseContext context)
    {
        _context = context;
    }
    ...
    public void OnGet()
    {
        ...
        {
            StockTakings = new List<StockTaking>();
            Products = new List<ProductStockViewModel>();
        }
    }
